...
//!
//! This is an internal API used by [`FluentBundleBase`] to evaluate Messages, Attributes and other
//! AST nodes to [`FluentValues`] which can be then formatted to strings.
//!
//! [`FluentValues`]: ../types/enum.FluentValue.html
//! [`FluentBundleBase`]: ../bundle/struct.FluentBundle.html
...
impl<'bundle, R: Borrow<FluentResource>, M: Memoizer> Scope<'bundle, R, M> {
...
fn get_arguments<'bundle, R, M: Memoizer>(
