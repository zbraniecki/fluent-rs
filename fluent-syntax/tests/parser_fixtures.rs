...
const WHITELIST: &[&str] = &[
    ...
    "tests/fixtures/member_expressions.ftl",
    "tests/fixtures/messages.ftl",
    "tests/fixtures/mixed_entries.ftl",
    "tests/fixtures/multiline_values.ftl",
    "tests/fixtures/numbers.ftl",
    "tests/fixtures/obsolete.ftl",
    "tests/fixtures/placeables.ftl",
    "tests/fixtures/reference_expressions.ftl",
    "tests/fixtures/select_expressions.ftl",
    "tests/fixtures/select_indent.ftl",
    "tests/fixtures/sparse_entries.ftl",
    "tests/fixtures/tab.ftl",
    "tests/fixtures/term_parameters.ftl",
    "tests/fixtures/terms.ftl",
    "tests/fixtures/variables.ftl",
    "tests/fixtures/variant_keys.ftl",
    "tests/fixtures/whitespace_in_value.ftl",
    "tests/fixtures/zero_length.ftl",
];
